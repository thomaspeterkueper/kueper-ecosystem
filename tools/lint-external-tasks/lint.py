...
CODES = {"ECO", "KG", "SSF", "NOXIA", "NXU", "MISH", "KUE", "OTA", "TKD"}
FILENAME_RE = re.compile(
    r"^EXT-(ECO|KG|SSF|NOXIA|NXU|MISH|KUE|OTA|TKD)-(ECO|KG|SSF|NOXIA|NXU|MISH|KUE|OTA|TKD)-\d{8}-\d{3}\.md$"
)
ID_RE = re.compile(
    r"^EXT-(ECO|KG|SSF|NOXIA|NXU|MISH|KUE|OTA|TKD)-(ECO|KG|SSF|NOXIA|NXU|MISH|KUE|OTA|TKD)-\d{8}-\d{3}$"
)
