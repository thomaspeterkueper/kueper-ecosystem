...
CODES = {"ECO", "BW", "KG", "SSF", "NOXIA", "NXU", "MISH", "OMNI", "AVI", "CONTRA", "ARCH", "ENDIA", "ZEREYA", "DAVARU", "FLHERM", "RESETH", "KUE", "OTA", "TKD"}
FILENAME_RE = re.compile(
    r"^EXT-(ECO|BW|KG|SSF|NOXIA|NXU|MISH|OMNI|AVI|CONTRA|ARCH|ENDIA|ZEREYA|DAVARU|FLHERM|RESETH|KUE|OTA|TKD)-(ECO|BW|KG|SSF|NOXIA|NXU|MISH|OMNI|AVI|CONTRA|ARCH|ENDIA|ZEREYA|DAVARU|FLHERM|RESETH|KUE|OTA|TKD)-\d{8}-\d{3}\.md$"
)
ID_RE = re.compile(
    r"^EXT-(ECO|BW|KG|SSF|NOXIA|NXU|MISH|OMNI|AVI|CONTRA|ARCH|ENDIA|ZEREYA|DAVARU|FLHERM|RESETH|KUE|OTA|TKD)-(ECO|BW|KG|SSF|NOXIA|NXU|MISH|OMNI|AVI|CONTRA|ARCH|ENDIA|ZEREYA|DAVARU|FLHERM|RESETH|KUE|OTA|TKD)-\d{8}-\d{3}$"
)
