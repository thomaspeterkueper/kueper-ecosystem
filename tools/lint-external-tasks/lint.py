...
CODES = {"ECO", "KG", "SSF", "NOXIA", "NXU", "MISH", "OMNI", "AVI", "CONTRA", "ARCH", "ENDIA", "ZEREYA", "DAVARU", "FLHERM", "RESETH", "BW", "ENG", "KUE", "OTA", "TKD"}
FILENAME_RE = re.compile(
    r"^EXT-(ECO|KG|SSF|NOXIA|NXU|MISH|OMNI|AVI|CONTRA|ARCH|ENDIA|ZEREYA|DAVARU|FLHERM|RESETH|BW|ENG|KUE|OTA|TKD)-(ECO|KG|SSF|NOXIA|NXU|MISH|OMNI|AVI|CONTRA|ARCH|ENDIA|ZEREYA|DAVARU|FLHERM|RESETH|BW|ENG|KUE|OTA|TKD)-\d{8}-\d{3}\.md$"
)
ID_RE = re.compile(
    r"^EXT-(ECO|KG|SSF|NOXIA|NXU|MISH|OMNI|AVI|CONTRA|ARCH|ENDIA|ZEREYA|DAVARU|FLHERM|RESETH|BW|ENG|KUE|OTA|TKD)-(ECO|KG|SSF|NOXIA|NXU|MISH|OMNI|AVI|CONTRA|ARCH|ENDIA|ZEREYA|DAVARU|FLHERM|RESETH|BW|ENG|KUE|OTA|TKD)-\d{8}-\d{3}$"
)
