...
CODES = {"ECO", "KG", "SSF", "NOXIA", "NXU", "MISH", "OMNI", "AVI", "CONTRA", "ARCH", "ENDIA", "ZEREYA", "DAVARU", "FLHERM", "RESETH", "KUE", "OTA", "TKD", "BW"}
FILENAME_RE = re.compile(
    r"^EXT-(ECO|KG|SSF|NOXIA|NXU|MISH|OMNI|AVI|CONTRA|ARCH|ENDIA|ZEREYA|DAVARU|FLHERM|RESETH|KUE|OTA|TKD|BW)-(ECO|KG|SSF|NOXIA|NXU|MISH|OMNI|AVI|CONTRA|ARCH|ENDIA|ZEREYA|DAVARU|FLHERM|RESETH|KUE|OTA|TKD|BW)-\d{8}-\d{3}\.md$"
)
ID_RE = re.compile(
    r"^EXT-(ECO|KG|SSF|NOXIA|NXU|MISH|OMNI|AVI|CONTRA|ARCH|ENDIA|ZEREYA|DAVARU|FLHERM|RESETH|KUE|OTA|TKD|BW)-(ECO|KG|SSF|NOXIA|NXU|MISH|OMNI|AVI|CONTRA|ARCH|ENDIA|ZEREYA|DAVARU|FLHERM|RESETH|KUE|OTA|TKD|BW)-\d{8}-\d{3}$"
)
